...
// Normalize Payload shape to what PortfolioCard expects
...
export default function OfferingsClient({ offerings }: { offerings: any[] }) {
    const portfolios = offerings.map(normalize)
