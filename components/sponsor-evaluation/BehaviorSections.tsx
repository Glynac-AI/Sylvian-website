...
export default function BehaviorSections() {
    ...
    return (
        <>
            {/* Section 01: Payment Behavior (White) */}
            ...
            {/* Section 02: Capital and Reserve Discipline (Gray) */}
            <section ref={sec2Ref} className="w-full border-b border-[#E5E7EB] overflow-hidden bg-gray-50">
                <div className="max-w-7xl mx-auto px-6 py-24">
                    <div className="grid lg:grid-cols-12 gap-16 items-center">
                        <motion.div 
            ...
            {/* Section 03: Forecast Accuracy (White) */}
            ...
            {/* Section 04: Disclosure Behavior (Gray) */}
            <section ref={sec4Ref} className="w-full border-b border-[#E5E7EB] overflow-hidden bg-gray-50">
                <div className="max-w-7xl mx-auto px-6 py-24">
                    <div className="grid lg:grid-cols-12 gap-16 items-center">
                        <motion.div 
                            className="lg:col-span-7 order-2 lg:order-1"
            ...
            {/* Section 05: Consistency Over Time (White) */}
