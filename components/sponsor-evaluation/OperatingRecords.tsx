...
export default function OperatingRecords() {
    return (
        <section className="bg-[#111827] py-32 text-white text-center">
            <div className="max-w-4xl mx-auto px-6">
                ...
                <p className="text-xl text-gray-400 font-serif italic mb-12">Longitudinal, comparable, decision-ready</p>

                <div className="grid md:grid-cols-3 gap-8 mb-16 text-left">
                    <div className="p-6 border border-gray-700 bg-white/5 rounded">
                ...
                <div className="flex flex-col md:flex-row gap-6 justify-center">
                    <RequestAccessButton className="bg-[#0A3F28] text-white px-10 py-4 text-xs font-bold tracking-widest uppercase hover:bg-[#145A3C] transition shadow-lg border border-transparent cursor-pointer">
