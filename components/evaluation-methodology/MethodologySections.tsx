...
export default function MethodologySections() {
    ...
    return (
        <>
            {/* Section 01: Standardized Structures (White) */}
            ...
            {/* Section 02: Mandatory Uniform Reporting (Gray) */}
                ...
                <div className="max-w-7xl mx-auto px-6 py-24">
                    <div className="grid lg:grid-cols-2 gap-24 items-center">
                        ...
                        >
                            ...
                            <h3 className="text-lg text-[#4B5563] mb-6 font-medium">Reporting is not optional.</h3>
            ...
            {/* Section 03: Platform-Tracked Events (White) */}
            ...
            {/* Section 04: Enforcement and Accountability (Gray) */}
                ...
                <div className="max-w-7xl mx-auto px-6 py-24">
                    <div className="grid lg:grid-cols-2 gap-24 items-center">
                        ...
                        >
                            ...
                            <h3 className="text-lg text-[#4B5563] mb-6 font-medium">Non-compliance is logged, reviewed, and acted on.</h3>
                            <p className="text-[#4B5563] mb-4 leading-relaxed">
            ...
            {/* Section 05: Auditability and Record Integrity (White) */}
            <section ref={sec5Ref} className="w-full border-b border-[#E5E7EB] overflow-hidden bg-white">
                <div className="max-w-7xl mx-auto px-6 py-24">
                    <div className="grid lg:grid-cols-2 gap-24 items-center">
                        <motion.div
                            initial={{ opacity: 0, x: -50 }}
                        ...
                        >
                            ...
                            <h3 className="text-lg text-[#4B5563] mb-6 font-medium">Evidence is timestamped and reviewable.</h3>
                            <p className="text-[#4B5563] mb-4 leading-relaxed">
