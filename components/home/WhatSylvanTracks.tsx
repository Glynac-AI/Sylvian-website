            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
                    ...
                    <motion.div
                        ...
                        animate={containerInView ? { opacity: 1, y: 0 } : {}}
                        transition={{ duration: 0.8, delay: 0 * 0.1, ease: [0.22, 1, 0.36, 1] }}
                    >
                    ...
                    <motion.div
                        ...
                        initial={{ opacity: 0, y: 30 }}
                        animate={containerInView ? { opacity: 1, y: 0 } : {}}
                        transition={{ duration: 0.8, delay: 1 * 0.1, ease: [0.22, 1, 0.36, 1] }}
                    >
                    ...
                    <motion.div
                        ...
                        initial={{ opacity: 0, y: 30 }}
                        animate={containerInView ? { opacity: 1, y: 0 } : {}}
                        transition={{ duration: 0.8, delay: 2 * 0.1, ease: [0.22, 1, 0.36, 1] }}
                    >
                    ...
                    <motion.div
                        ...
                        initial={{ opacity: 0, y: 30 }}
                        animate={containerInView ? { opacity: 1, y: 0 } : {}}
                        transition={{ duration: 0.8, delay: 3 * 0.1, ease: [0.22, 1, 0.36, 1] }}
                    >
                        <div className="h-24 mb-6 border-b border-[#0A3F28] flex items-center">
                    ...
                    <motion.div
                        ...
                        initial={{ opacity: 0, y: 30 }}
                        animate={containerInView ? { opacity: 1, y: 0 } : {}}
                        transition={{ duration: 0.8, delay: 4 * 0.1, ease: [0.22, 1, 0.36, 1] }}
                    >
