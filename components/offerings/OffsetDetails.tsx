...
export default function OffsetDetails() {
    return (
                    ...
                    <Reveal delay={200}>
                        <div className="rounded-2xl border border-slate-200 p-8">
                            ...
                            <p className="mb-4 text-slate-600">
                                Designed for investors who prefer depreciation timing over current cash.
                            </p>
                            <div className="rounded-lg bg-blue-50 p-4">
                                <span className="block text-sm text-slate-500">Illustrative Range</span>
                                <span className="text-2xl font-bold text-blue-600">~4.5 - 5.0%</span>
                            </div>
